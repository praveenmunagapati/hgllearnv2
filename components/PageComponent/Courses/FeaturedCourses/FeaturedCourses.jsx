...
function FeaturedCourses() {
  return (
    <div className="md:grid lg:grid xl:grid xxl:grid grid-cols-2 gap-20 m-14 mx-auto  w-11/12 md:w-10/12 px-3 md:px-8 py-6  bg-[#EEEAEA] bg-opacity-50">
      <div className=" px-3">
      ...
      <div className="md:flex     lg:flex xl:flex xxl:flex gap-4 ">
        ...
        <div>
          <div className="flex mt-4 gap-1 lg:w-40 xl:w-40 xxl:w-40   px-4 md:px-0 lg:px-0 xl:px-0 xxl:px-0 justify-start md:justify-center lg:justify-center xl:justify-center xxl:justify-center  mx-auto md:w-fit bg-main h-fit text-white py-4">
            <div className="mt-1">
              <BiCalendarWeek />
            </div>
          ...
          <div className="flex mt-4 gap-1  md:w-fit mx-auto lg:w-40 xl:w-40 xxl:w-40  bg-yellow-400 h-fit  p-4">
            <div className="mt-1">
              <BiCalendarWeek />
            </div>
            <div className="Poppins ">
