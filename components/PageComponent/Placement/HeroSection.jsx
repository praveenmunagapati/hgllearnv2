...
const HeroSection = () => {
  return (
    <>
      <section className="">
        <div className=" mx-auto flex px-5 py-24 md:flex-row lg:flex-row xl:flex-row xxl:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 xl:w-[30vw]  xxl:w-[50vw] flex flex-col md:items-start md:text-left mb-16 md:mb-0 ">
          ...
          <div className="xs:hidden sm:hidden lg:max-w-lg lg:w-full md:w-1/2 xl:w-3/6 xxl:w-3/6">
            <Image
