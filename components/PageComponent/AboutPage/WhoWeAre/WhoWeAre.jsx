      ...
      <div className="grid grid-cols-1 gap-12 mt-1 lg:grid-cols-2 xl:grid-cols-2 xxl:grid-cols-2 ">
        <div className="row-start-2 lg:row-start-1  xl:row-start-1 text-justify xxl:row-start-1">
          <div className="text-xs xl:text-sm xxl:text-base text-gray-700 text-justify">
            ...
            <br />Here everyone gets the same opportunity to leverage our services to learn the skills necessary for making a living in the digital workplace.We believe that investing in youth education will help the freelancing marketplaces with more skilled and qualified workers.
