    ...
    <div className="px-4 lg:px-8 xl:px-9 xxl:px-10 bg-black py-8 ">
      ...
      <div className="flex flex-col md:gap-6 lg:gap-10 xl:gap-10 xxl:gap-10 md:flex-row lg:flex-row xl:flex-row xxl:flex-row lg:items-center xl:items-center xxl:items-center justify-between pb-2 space-y-5 md:space-y-0">
        ...
        <div className="flex items-center space-x-4 text-xl ">
          <FaFacebookF className="text-white cursor-pointer transition textPrimary" />
          <BsTwitter className="text-white cursor-pointer transition textPrimary" />
          <AiFillInstagram className="text-white cursor-pointer transition textPrimary" />
          <FaTiktok className="text-white cursor-pointer transition textPrimary" />
          <BsWhatsapp className="text-white cursor-pointer transition textPrimary" />
        </div>
