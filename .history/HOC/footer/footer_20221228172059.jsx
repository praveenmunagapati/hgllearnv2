...
function Footer() {
  const Wicon = [
    {
      Icon: <BsWhatsapp />,
      path: "https://l.messenger.com/l.php?u=https%3A%2F%2Fwa.me%2Fmessage%2FR23HVVD5DWPVI1&h=AT1HjxPh0MDr-fW7LGMGmBXVE3lPwYLXzgpfytbVj9omwnoCW9w8xbuuxoiNU00HjFhVzLNLc5fOzRXNWs_lqXMbyUv8xt-8SHzx-PL9OEls7ZDHDBbUE94pFgVnDqYEhwQ_6-OBNrrJz84OYa6Ifw",
    },
  ];
...
"
      ...
      {/* bottom section ends  */}
      {/* whatsapp widget */}
      <div className="text-main text-4xl bottom-5 right-5 fixed cursor-pointer transition textPrimary">
        {Wicon.map((val, i) => {
          return (
            <div key={i}>
