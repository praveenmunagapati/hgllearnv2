                      ...
                      return (
                        <div key={i} className="">
                          <Field
                            ...
                            className="border-none rounded-md py-2 px-3 text-[18px] text-gray-500 bg-gray-200"
                          >
                      ...
                      return (
                        <div key={i} className="flex flex-col py-2 ">
                          <Field
                            ...
                            className="border-none rounded-md text-base text-gray-500 py-2 px-3 capitalize bg-gray-200"
                          />
