...
function Inquiry() {
  ...
  return (
    <>
      <div className="border-2 border-black fixed top-40 bottom-50 right-0 w-fit h-fit bg-slate-300 text-center py-24 space-y-7">
        <Formik
          initialValues={{
            FullName: "",
            email: "",
        ...
        >
          {({ handleSubmit }) => {
              ...
              <Form onSubmit={handleSubmit} className="">
                ...
                <div>
                  <p className="text-sm flex gap-1">
                    <input type="checkbox" className="h-10" />I agree with the
            ...
            bg-main text-white text-lg border-none rounded-full capitalize"
                >
                  send request
                </button>
              </Form>
