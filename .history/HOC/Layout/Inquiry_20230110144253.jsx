  ...
  return (
    <>
      <div>
        ...
        {/* form body */}
        <div
          className={`border-none rounded-md fixed top-36 bottom-520 right-0 w-72 h-fit bg-white shadow-xl shadow-gray-500 text-center py-5 cursor-pointer ${
            Show
                    ...
                    if (val.as === "select") {
                      ...
                      return (
                        <div key={i} className="flex flex-col py-2 ">
                          ...
                          />
                          <ToastContainer className="absolute text-red-800" />
