...
function Inquiry({ Show, setShow }) {
  ...
  return (
    <>
      <div
        className={`border-none rounded-md fixed top-40 bottom-50 w-80 h-fit bg-white shadow-xl shadow-gray-500 text-center py-5 cursor-pointer ${
          Show ? "-mr-52" : "ease-in-out duration-500 delay-100"
        }`}
      >
