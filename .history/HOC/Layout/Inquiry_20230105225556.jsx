...
function Inquiry({ Show, setShow }) {
  ...
  return (
    <>
      <div
        className={`border-none rounded-md fixed top-40 bottom-50 right-0 w-80 h-fit bg-white shadow-xl shadow-gray-500 text-center py-5 cursor-pointer hidden ${
          Show === true && "transition-all duration-300 delay-100 right-0"
        } ${
          setShow === false &&
          "transition-all duration-100 delay-100 -right-[100%]"
        }`}
      >
