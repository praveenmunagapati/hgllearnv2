...
function Inquiry() {
  ...
  return (
    <>
      <div className="border-none rounded-md fixed top-40 bottom-50 right-0 w-80 h-fit bg-white shadow-xl shadow-gray-500 text-center py-5">
        <div className="flex justify-between px-5">
          <h1 className="capitalize text-center text-main text-xl">
            get in touch
          </h1>
          <GrClose className="text-3xl text-white -mt-8 border-none bg-main font-bold rounded-full p-1" />
        </div>
        <Formik
          initialValues={{
            FullName: "",
          ...
          {({ handleSubmit }) => {
            return (
              <Form onSubmit={handleSubmit} className="px-5">
                ...
                <button
                  type="submit"
                  className="w-fit h-fit px-8 py-3 mt-5
