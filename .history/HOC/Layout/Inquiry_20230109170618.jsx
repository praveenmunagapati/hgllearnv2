      ...
      <div>
        ...
        <div>
          <button
            ...
            className="capitalize bg-main text-white fixed top-80 bottom-50 right-10 border-none rounded-lg p-2"
          >
            send us inquiry
          </button>
        </div>
                      ...
                      return (
                        <div key={i} className="flex flex-col py-2 ">
                          <Field
                            ...
                            name={val.name}
                            value={val.values}
                            className="border-none rounded-md py-2 px-3 text-gray-500 bg-gray-200"
                          >
