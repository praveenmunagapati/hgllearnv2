  ...
  return (
    <div>
      <div className="flex justify-center  items-center px-8">
        ...
        <div
          className="grid grid-cols-1 w-11/12  gap-2 md:grid-cols-1 md:text-center
            ...
            return (
              <div key={i} className="flex w-full relative">
                ...
                <div className="bg-gray-200  h-32 w-9/12 mx-auto rounded-2xl px-16 py-3">
                  ...
                  <div className="text-xs h-16 text-gray-600 pb-4  overflow-scroll info xs:text-center md:text-center ">
                    {val.description}
                  </div>
                </div>
              </div>
