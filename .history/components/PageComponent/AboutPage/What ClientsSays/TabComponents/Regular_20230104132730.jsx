  ...
  return (
    <div>
      <div className="flex justify-center  items-center px-8">
        ...
        <div
          className="grid w-11/12 gap-2 text-center md:grid-cols-1 
            ...
            return (
              <div key={i} className="flex w-full relative">
                ...
                <div className="  h-32 w-9/12 mx-auto rounded-2xl px-16 py-3 text-center bg-slate-200 ">
                  <div className="text-main Poppins font-medium capitalize md:text-sm lg:text-xl xl:text-xl xxl:text-xl">
                    {val.name}
                  </div>
