  ...
  return (
    <div>
      <div className="flex justify-center  items-center px-8">
        ...
        <div
          className="grid grid-cols-1 w-11/12 gap-2 text-center md:grid-cols-1 bg-red-700 
          ...
          {clientDetails?.slice(StartValue, EndValue)?.map((val, i) => {
            return (
              <div key={i} className="flex w-full relative">
                ...
                <div className="bg-gray-200  h-32 w-9/12 mx-auto rounded-2xl px-16 py-3 text-center bg-green-700">
                  ...
                  <div className="text-xs h-16 text-gray-600 pb-4  overflow-scroll info ">
                    {val.description}
                  </div>
                </div>
              </div>
