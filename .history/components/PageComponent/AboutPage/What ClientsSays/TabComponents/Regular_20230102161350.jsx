  ...
  return (
    <div>
      <div className="flex justify-center  items-center px-8">
        ...
        <div
          className="grid grid-cols-1 w-11/12  gap-2 md:grid-cols-1 
         lg:grid-cols-2 xl:grid-cols-2 xxl:grid-cols-2  pt-12S"
        >
          {clientDetails?.slice(StartValue, EndValue)?.map((val, i) => {
            return (
              <div key={i} className="flex w-full relative md:text-center">
                <div
