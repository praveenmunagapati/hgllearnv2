  ...
  return (
    <div>
      <div className="py-5 text-center">
        <div className="  md:text-2xl lg:text-2xl xl:text-2xl xxl:text-2xl text-main capitalize Poppins">
          <h1 className="text-[18px]">What our students say about us</h1>
        </div>
