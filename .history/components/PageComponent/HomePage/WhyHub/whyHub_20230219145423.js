...
const WhyHub = () => {
  ...
  return (
    <div className="px-4 md:px-8 lg:px-20 xl:px-24 xxl:px-32 w-full h-max my-16 Poppins">
      <div className="flex flex-col lg:flex-row xl:flex-col xxl:flex-row w-full h-max gap-7 items-center justify-center">
        <div className="flex flex-col justify-center  w-full lg:w-2/6 xl:w-2/6 xxl:w-2/6 ">
            ...
            return (
              <div key={i}>
                <div className="flex h-full gap-4 flex-row items-center ">
                  ...
                  <div className="w-full h-full text-justify text-xs xl:text-xs  xxl:text-base text-gray-700">
                    {item.description}
                  </div>
                  </div>
                </div>
