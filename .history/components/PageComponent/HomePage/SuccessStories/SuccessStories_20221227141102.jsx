...
function SuccessStories() {
  ...
  return (
    <div className=" mt-16 lg:mt-16 xl:mt-16 xxl:my-16  px-24 lg:mb-14 xl:mb-14 xxl:mb-14">
      <div className="md:text-2xl lg:text-2xl xl:text-2xl xxl:text-2xl text-center  text-main Poppins font-bold capitalize">
        <h2 className="text-xl">some of our students success stories</h2>
      </div>
      <div
