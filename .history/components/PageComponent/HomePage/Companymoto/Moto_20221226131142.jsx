...
function Moto({ icon, title, description }) {
  return (
    <div
      className="ml-8 mr-5 border-b lg:border-b-0 xl:border-b-0 
    ...
    >
      ...
      <div
        className="text-xs xl:text-sm xxl:text-base text-gray-700
       text-justify mb-4 h-36 xl:h-40 xxl:h-52 py-2 scroll overflow-scroll "
      >
        {description}
      </div>
    </div>
