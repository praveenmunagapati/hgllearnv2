...
function CallSection() {
  ...
  return (
    <div>
      <div className="bg-[#EEEAEA] flex  justify-between mt-7 lg:mt-14 xl:mt-14 xxl:mt-14 py-8  lg:py-24 xl:py-24 xxl:py-24 ">
        <div>
              ...
              <div className="my-4 tablet:flex m  w-11/12 tablet:w-7/12 laptop:w-7/12 desktopL:w-6/12 mx-auto">
                <div className="  w-full  ">
                  <Field
                    ...
                    className="px-4 py-2 rounded-2xl laptop:h-10 desktop:h-12 capitalize text-sm tablet:text-base desktop:text-lg w-fit font-normal border"
                  />
                ...
                <button
                  className="h-8 xl:h-10 xxl:h-12 my-3 sm:my-0 lg:my-0 xl:my-0 md:my-0 xxl:my-0  w-full sm:w-40 md:w-44 lg:w-44 xl:w-44 xxl:w-44   font-semibold    border-none outline-none rounded
