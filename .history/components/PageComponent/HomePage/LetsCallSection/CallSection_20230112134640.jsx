            ...
            <Form>
              <div className="my-2 tablet:flex m  w-11/12 tablet:w-7/12 laptop:w-7/12 desktopL:w-6/12 mx-auto">
                <div className="  w-full flex gap-10  ">
                  <div className="flex broder-2 border-black bg-white ">
                    <IoPerson className="text-xl mt-[3%] px-2 "/>
                  <Field
                    name="name"
                    placeholder="Fullname"
                    className="px-6 py-2  laptop:h-10 desktop:h-12 capitalize text-sm tablet:text-base desktop:text-lg w-fit font-normal "
                  />
                  </div>
                  {/* phone field */}
                  <Field
