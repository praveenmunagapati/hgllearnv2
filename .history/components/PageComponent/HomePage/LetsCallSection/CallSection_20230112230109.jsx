    ...
    <>
      <div className="w-full bg-[#EEEAEA] mt-7 lg:mt-14 xl:mt-14 xxl:mt-14 py-8  lg:py-24 xl:py-24 xxl:py-24 ">
        <div className="flex gap-10 justify-evenly w-full">
          ...
          <div className="capitalize py-4  text-center">
           <h2 className="text-4xltext-xl xl:text-2xl xxl:text-2xl font-bold Poppins"> let us give you a <span className="text-main">quick call</span>!</h2>
