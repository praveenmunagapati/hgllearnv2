  ...
  return (
    <>
      <div className="w-full bg-[#EEEAEA] mt-7 lg:mt-14 xl:mt-14 xxl:mt-14 py-8  lg:py-24 xl:py-24 xxl:py-24 ">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 xxl:grid-cols-2">
            ...
            {({ handlesubmit }) => (
              <Form method="post" onSubmit={handlesubmit}>
                <div className="flex flex-colml">
                  ...
                  <div className="">
                    <button className="bg-main text-white font-bold text-sm rounded-xl px-6 py-2 ml-5 w-fit ">Submit</button>
