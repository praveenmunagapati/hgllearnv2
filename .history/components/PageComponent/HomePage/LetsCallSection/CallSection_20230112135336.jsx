              ...
              <div className="my-2 tablet:flex m  w-11/12 tablet:w-7/12 laptop:w-7/12 desktopL:w-6/12 mx-auto">
                <div className="  w-full flex gap-10  ">
                  ...
                  <div className="flex border-none rounded-2xl bg-white">
                    <BsTelephoneFill className="text-lg text-gray-600 mt-[3%] ml-2"/>
                  <Field
                    name="phone"
                    
                    placeholder="Phone no."
                    className="px-6 py-2 rounded-2xl laptop:h-10 desktop:h-12 capitalize text-sm tablet:text-base desktop:text-lg w-fit font-normal border"
                  />
                 </div>
                </div>
