...
const PlacementPartners = () => {
  ...
  return (
    <div className=" px-4 md:px-8 lg:px-20 xl:px-24 xxl:px-32 mt-10 flex flex-col items-center ">
      ...
      <div className="w-full grid  grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 xxl:grid-cols-2 gap-3 my-6">
        {Placement.map((item,i) => {
          return (
            <div key={i} className="w-max my-0  flex justify-around items-center   h-fit">
            <div className=" ml-50  w-96 h-24 relative ">
