...
import {SiMicrosoft} from "react-icons"
...
const PlacementPartners = () => {
  ...
  return (
    <div className=" px-4 md:px-8 lg:px-20 xl:px-24 xxl:px-32 mt-10 flex flex-col items-center ">
      ...
      <div className=" grid  grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 xxl:grid-cols-2 my-6">
        {Placement.map((item,i) => {
          return (
            // <div key={i} className="">
            // <div className=" w-94  h-14 flex justify-evenly relative">
