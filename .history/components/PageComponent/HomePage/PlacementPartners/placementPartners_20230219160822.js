...
const PlacementPartners = () => {
  ...
  return (
    <div className=" px-4 md:px-8 lg:px-20 xl:px-24 xxl:px-32 mt-10 flex flex-col items-center ">
      <div className="w-max  text-red-400 text-lg xl:text-xl xxl:text-2xl capitalize Poppins my-10 font-bold">
        Placement Partners
      </div>
      <div className="w-full grid  grid-cols-1 lg:grid-cols-5 xl:grid-cols-5 xxl:grid-cols-5 gap-3 my-6">
