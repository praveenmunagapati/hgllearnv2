            ...
            <div className="   ">
              <div className="w-72  relative sm:w-72 lg:w-64 md:w-96 xl:w-80 xxl:w-72">
                ...
                <div className="absolute top-48 left-24 ">
                  <BsPlayCircleFill className="h-12 w-12 border-none transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-main duration-300 ..." />
                </div>
              </div>
            </div>
            <div
