            ...
            <div className="   ">
              <div className="w-72  relative   bg-main sm:w-72 lg:w-64 md:w-96 xl:w-80 xxl:w-72">
                ...
                <div className="absolute top-48 left-24 ">
                  <AiFillPlayCircle className="h-14 w-14 text-white" />
                </div>
              </div>
            </div>
            <div
            ...
            >
              {images.map((val, i) => {
                return (
                  <div
                    key={i}
                    className="bg-green-500 sm:w-60 hovr:scale-105 transition-all duration-300  cursor-pointer ease-in-out w-72 md:w-64 lg:w-40 xl:w-52
                   xxl:w-48"
                  >
                    <Image
                      src={val.image}
