...
function AdmissionForm() {
  ...
  const AdmissionFormSchema = Yup.object().shape({
    ...
    guardianNumber: Yup.string().required("Required"),
    phone: Yup.string().required("Required"),
    levelOfEducation: Yup.string().required("Required"),
    collegeOrSchoolName: Yup.string().required("Required"),
  ...
  const Submit = (values) => {
    axios
      .post("http://192.168.0.18:4000/onlineform/files")
      .then((res) => {
        if (res.status === 200) {
                                ...
                                return (
                                  <div className=" ">
                                    <Field
                                      as={"select"}
                                      name={val.name}
                                      className=" w-full bg-[#EEEAEA] Poppins text-sm h-9 capitalize px-36 py-1
