              ...
              <div>
                <Form onSubmit={handleSubmit}>
                  <div className="flex flex-col  px-7 mb-16">
                    ...
                    <div className="grid grid-cols-3 bg-red-600 gap-16 col-start-3  px-40 mt-16 ">
                        ...
                        if (val.Gender) {
                          ...
                          if (val.grid) {
                            return val.grid.map((val, i) => {
                              return (
                                <div key={i} className="bg-red-500  w-full">
                  ...
                  <div className="bg-green-400 place-content-center">
                    <div>
