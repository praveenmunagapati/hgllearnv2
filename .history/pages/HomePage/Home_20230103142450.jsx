      ...
      >
        <div className="h-max md:w-3/6 lg:w-3/6 xl:w-3/6 xxl:w-3/ 6 w-full ">
          ...
          <div className="flex mt-6">
            <button
              className={
                "border-[1.5px] border-[#A0047D] rounded-full mr-6 px-2 py-[5px] text-sm xl:text-base xxl:text-lg text-main hover:scale-105 transition-all ease-in-out duration-300 delay-100 hover:bg-main hover:text-white"
              }
            >
              Explore More...
            </button>
            <div className=" h-max items-center cursor-pointer">
              <div className="flex border-[1.5px] border-[#A0047D] rounded-full mr-6 px-2 py-[2px] text-sm xl:text-base xxl:text-lg text-main hover:scale-105 transition-all ease-in-out duration-300 delay-100 hover:bg-main hover:text-white">
                <AiFillPlayCircle className="text-[#a0047d] text-4xl p-2 md:hidden xl:text-4xl xxl:text-5xl" />
                <p className=" md:text-base xl:text-lg xxl:text-xl text-[#a0047d] text-center ">
                  Watch Now
                </p>
              </div>
            </div>
