      ...
      >
        <div className="h-max md:w-3/6 lg:w-3/6 xl:w-3/6 xxl:w-3/ 6 w-full ">
          ...
          <div className="flex py-8">
            ...
            <div className="">
              <div className="flex gap-2 items-center border border-main rounded-full py-1">
                <div>
                  <AiFillPlayCircle className="text-3xl text-main ml-2" />
                </div>
                <button className="text-main text-2xl mr-1">watch now</button>
              </div>
            </div>
          </div>
        </div>
