        ...
        <div className="h-max md:w-3/6 lg:w-3/6 xl:w-3/6 xxl:w-3/ 6 w-full ">
          ...
          <div className="flex mt-6">
            ...
            <div className=" h-max items-center cursor-pointer">
              <div className="flex border-[1.5px] border-main rounded-full w-[13vw] ">
                <div className=" hover:scale-75 transition-all ease-in-out duration-300 delay-100 hover:bg-main hover:text-white">
