      ...
      >
        <div className="h-max lg:w-3/6 xl:w-3/6 xxl:w-3/ 6 w-full ">
          ...
          <div className="flex mt-6">
            ...
            <div className="flex h-max items-center cursor-pointer hover:scale-105 transition-all ease-in-out duration-300 delay-100 hover:border border-[1.5px] w-18 border-main">
