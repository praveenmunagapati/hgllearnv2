      ...
      >
        <div className="h-max md:w-3/6 lg:w-3/6 xl:w-3/6 xxl:w-3/ 6 w-full ">
          ...
          <div className="flex py-8">
            <button
              className={
                "border border-[#A0047D] rounded-full mr-6 text-sm xl:text-base xxl:text-lg text-main hover:scale-105 transition-all ease-in-out duration-300 delay-100 hover:bg-main hover:text-white"
              }
            >
              Explore More...
            </button>
