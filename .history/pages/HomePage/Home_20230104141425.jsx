      ...
      >
        <div className="h-max md:w-3/6 lg:w-3/6 xl:w-3/6 xxl:w-3/ 6 w-full ">
          ...
          <div className="flex py-8">
            ...
            <div className="">
              <div className="flex gap-1 items-center border-[1.5px] border-main rounded-full py-1 hover:bg-main group  group-hover:scale-105 transition-all ease-in-out duration-300 delay-100 group-hover:text-white">
                <div>
